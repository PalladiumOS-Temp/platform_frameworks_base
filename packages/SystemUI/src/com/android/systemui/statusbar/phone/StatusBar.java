...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    public void start() {
        ...
        mPalladiumSettingsObserver.observe();
        mPalladiumSettingsObserver.update();
    ...
    private PalladiumSettingsObserver mPalladiumSettingsObserver = new PalladiumSettingsObserver(mHandler);
    private class PalladiumSettingsObserver extends ContentObserver {
        PalladiumSettingsObserver(Handler handler) {
            super(handler);
        }
